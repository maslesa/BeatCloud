  ...
  return (
    <div className="fixed inset-0 bg-mybg/50 flex justify-center items-center z-50">
      <div className="bg-mylight p-6 rounded-xl w-100 relative flex flex-col items-center">
        ...
        <input className="border p-2 w-full mb-2 border-mybg text-mybg rounded" placeholder="Username" />
        <input className="border p-2 w-full mb-2 border-mybg text-mybg rounded" placeholder="Email" />
        <input className="border p-2 w-full mb-4 border-mybg text-mybg rounded" type="password" placeholder="Password" />

        <button className="bg-mybg text-mylight w-full py-3 rounded mb-5 flex items-center justify-center gap-2 cursor-pointer hover:bg-mybg2 duration-200">
